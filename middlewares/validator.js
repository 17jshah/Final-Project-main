...
exports.validateSignup = [
  ...
  body(
    "password",
    "password must be atleast 8 character and atmost 64 character"
...
exports.validateconnection = [
  body(
    "title",
    "title should be atleast 3 character long (except trailling spaces)"
  )
    .notEmpty()
    .bail()
    .trim()
  ...
  body(
    "category",
    "category should be atleast 3 character long (except trailling spaces)"
  )
    .notEmpty()
    .bail()
    .trim()
  ...
  body(
    "details",
    "detail should be atleast 10 character long (except trailling spaces)"
  )
    .notEmpty()
    .bail()
    .trim()
  ...
  body(
    "date",
    "date should be in future (not today or past) and should be valid"
  )
    .notEmpty()
    .bail()
    .trim()
    .escape()
    .custom((value, { req }) => checkDate(value)),
  body(["endTime", "startTime"], " Please provide valid time")
    .notEmpty()
    .bail()
    .trim()
    .escape()
    .custom((value, { req }) => checkValidTime(value)),
  body(
    "endTime",
    "end time should be after start time and connection should be atleast 5 mins long"
  )
    .notEmpty()
    .bail()
    .trim()
    .escape()
    .custom((value, { req }) =>
      checkStartAndEndTime(req.body.startTime, value)
    ),
